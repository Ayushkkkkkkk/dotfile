...
vim.api.nvim_exec([[
  augroup cpp_mappings
    ...
    autocmd FileType cpp nnoremap <buffer> <C-A-c> :terminal ./%:r<CR>
...
vim.cmd([[
  autocmd FileType go nnoremap <buffer> <C-A-g> :terminal go run %
]])
...
vim.cmd('highlight Whitespace guibg=bg')
